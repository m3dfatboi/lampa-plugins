/* subs-stable (OSv3-style, interactive tabs, ESC close, persistent settings, globe button v2)
   Кнопка: круглая, без обводки, крупнее, выровнена по ряду, новая SVG-иконка.
*/
(function () {
  const FLAG='__SUBS_STABLE_OSV3_FULL_GLOBE_V2__';
  ...
  // ===== Player controls globe button (v2) =====
  (function(){
    const ID='subs-stable-btn';
    const BTN_SIZE='2.6em'; // легко менять размер одной строкой
    // Обновлённая иконка глобуса (другой силуэт)
    const GLOBE_SVG = `
      <svg viewBox="0 0 24 24" width="1em" height="1em" aria-hidden="true" focusable="false">
        <path d="M12 22C6.48 22 2 17.52 2 12S6.48 2 12 2s10 4.48 10 10-4.48 10-10 10Zm-1-2.03A8.01 8.01 0 0 1 4.05 13H8c.2 2.7 1.25 5.02 3 6.97ZM4.05 11A8.01 8.01 0 0 1 11 4.03C9.25 6 8.2 8.3 8 11H4.05ZM13 4.03A8.01 8.01 0 0 1 19.95 11H16c-.2-2.7-1.25-5.02-3-6.97ZM16 13h3.95A8.01 8.01 0 0 1 13 19.97c1.75-1.95 2.8-4.27 3-6.97Z"></path>
      </svg>
    `;
    ...
    function ensure(){
      ...
      btn.style.cssText=[
        ...
        'outline:none','padding:0','margin:0 .25em','vertical-align:middle',
        // мелкий нудж, чтобы попасть в общий ряд некоторых тем
      ...
      // Пытаемся вставить сразу после стандартной кнопки субтитров для “ровня”
